-- Recreate product_inventory_phase_details (view + indexes + functions).
--
-- in_delivery:
--   status = 'processing'
--   OR (status = 'returned'
--       AND yalidine_status IS DISTINCT FROM 'Retour à retirer'
--       AND dc_recent_status IS DISTINCT FROM 'recupere_par_fournisseur')
